...
class BlackScholesProcess:
    ...
    def get_process(self, calculation_date=ql.Date.todaysDate()):
        ...
        dividend_yield = ql.YieldTermStructureHandle(
            ql.FlatForward(0, ql.NullCalendar(), dividend_handle, self.day_count))
...
print("day count is ", day_count.yearFraction(calculation_date,calculation_date + 365))
volatility = ql.BlackConstantVol(0, ql.NullCalendar(), 0.2, day_count)
volatility